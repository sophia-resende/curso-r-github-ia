...
# Integração do ChatGPT e Claude no RStudio
...
## 1.1 O que são LLMs (Large Language Models)?
...
## 1.4 Boas Práticas de Uso Responsável de IA
...
# Parte 2: Configuração de Chaves e Ambiente (19h30 - 20h15)

## 2.1 Variáveis de Ambiente no R
...
3. **Importante:** Configure um limite de gastos!
   - Recommended: $5-10/mês para aprendizado
...
## 3.3 Explicar Código Selecionado
...
## 3.4 Comentar Código Automaticamente
...
## 3.6 Casos de Uso Práticos com ChatGPT
...
## 4.5 Casos de Uso Práticos com Claude
...
# Parte 5: Exercício Guiado de Integração (21h30 - 22h00)

## 5.1 Tarefa 1: Revisar código com gptstudio
...
3. Depois use gptstudio → Write Code com prompt:
...
## 5.2 Tarefa 2: Gerar função com chattr (Claude)
...
## 5.3 Tarefa 3: Documento de Reflexão
