...
# RStudio + gptstudio (ChatGPT) (20h30 - 21h00)

## Conhecendo o gptstudio
...
gptstudio::get_available_models(service = "anthropic")

# Para Google (Gemini)
# gptstudio::get_available_models(service = "google")

# Para Azure OpenAI
# gptstudio::get_available_models(service = "azure_openai")
```

```{r}
# Configurar o modelo globalmente via variável de ambiente
# Sys.setenv(OPENAI_MODEL = "gpt-4")
Sys.setenv(OPENAI_MODEL = "gpt-3.5-turbo")
# Sys.setenv(OPENAI_MODEL = "gpt-4-turbo-preview")
```

```{r}
# Especificar o modelo diretamente na chamada
# gptstudio::chat(
...
```{r}
# No console
gptstudio::chat("Qual é a capital do Brasil?")
```
...
gptstudio::chat("Como criar um vetor em R?")
...
## Chamadas via API Manual (Claude)
...
## Tarefa 1: Revisar código com gptstudio
